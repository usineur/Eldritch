...
namespace Noise
{
	...
	// Cubic noise functions return range -1..1
	...
	float	SumNoise1( float x, const uint Octaves, Noise1Func NoiseFunc );
	float	SumNoise2( float x, float y, const uint Octaves, Noise2Func NoiseFunc );
	float	SumNoise3( float x, float y, float z, const uint Octaves, Noise3Func NoiseFunc );
	...
	// Use this to normalize the result of SumNoise.
	float	GetOctaveScale( const uint Octaves );

	// For noise range -1..1, these approach range 0..2 as Octaves approaches infinity
	// For noise range 0..1, these approach range 0..2
	float	SumAbsNoise1( float x, const uint Octaves, Noise1Func NoiseFunc );
	float	SumAbsNoise2( float x, float y, const uint Octaves, Noise2Func NoiseFunc );
	float	SumAbsNoise3( float x, float y, float z, const uint Octaves, Noise3Func NoiseFunc );
