...
#define PROFILE_FUNCTION DoNothing
#define PROFILE_SCOPE(n) DoNothing
#define PROFILE_BEGIN(n) DoNothing
#define PROFILE_END DoNothing

#define FRAME_PROFILE_FUNCTION DoNothing
#define FRAME_PROFILE_SCOPE(n) DoNothing
#define FRAME_PROFILE_BEGIN(n) DoNothing
#define FRAME_PROFILE_END DoNothing

#define DEBUG_PROFILE_FUNCTION DoNothing
#define DEBUG_PROFILE_SCOPE(n) DoNothing
#define DEBUG_PROFILE_BEGIN(n) DoNothing
#define DEBUG_PROFILE_END DoNothing

#define DEBUG_FRAME_PROFILE_FUNCTION DoNothing
#define DEBUG_FRAME_PROFILE_SCOPE(n) DoNothing
#define DEBUG_FRAME_PROFILE_BEGIN(n) DoNothing
#define DEBUG_FRAME_PROFILE_END DoNothing
