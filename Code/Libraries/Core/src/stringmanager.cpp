...
// f: float
// s: string
// l: localized string (i.e., do a config lookup and then localize that key)
// k: localize (i.e., don't do a config lookup, just localize the given string key)
// n: non-localized config string (looked up as non-localized config string, then recursively parsed)
// c: config string (looked up as localized string, then recursively parsed)
