...
#include "BTNodes/rodinbtnodeactiondecorator.h"
#include "BTNodes/rodinbtnodeconditiontimeout.h"
...
ADDRODINBTNODEFACTORY( ActionDecorator );
ADDRODINBTNODEFACTORY( ConditionTimeout );
