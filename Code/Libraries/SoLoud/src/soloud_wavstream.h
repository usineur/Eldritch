...
namespace SoLoud
{
	...
	public:
		...
		// DLP 11 Dec 2018: Support seeking on looping sounds
		virtual time getLength();
	...
	public:
		...
		// DLP 22 Aug 2018: optimize Vorbis loads
		unsigned int mCachedChannels;
		float mCachedSampleRate;
		unsigned int mCachedSampleCount;
