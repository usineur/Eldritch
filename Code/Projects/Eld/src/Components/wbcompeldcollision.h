...
class WBCompEldCollision : public WBEldComponent
{
public:
	WBCompEldCollision();
	virtual ~WBCompEldCollision();

	DEFINE_WBCOMP( EldCollision, WBEldComponent );
...
private:
	...
	uint				m_CollisionFlags;					// Config/serialized, see EldWorld::ECollisionFlags
