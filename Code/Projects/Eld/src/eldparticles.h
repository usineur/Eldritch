#ifndef ELDPARTICLES_H
#define ELDPARTICLES_H
...
private:
	struct SParticle
	{
		...
		float	m_SpawnTime;			// Timestamp
		float	m_ExpireTime;			// Timestamp
		float	m_Size;
	...
	typedef Map<HashedString, EldParticles::SParticleSystemParams> TParamCache;
	static TParamCache		sm_ParamCache;
};

#endif // ELDPARTICLES_H
